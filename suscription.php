        ...
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <h1 class="h1"><strong>Tipos de Suscripciones</strong></h1>
                    <p>
                        Aquí puedes ver las principales ventajas que obtendrás por <br><strong>sólo 12,99€ al mes:</strong>
                    </p>
                </div>
            </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <a href="shop-single.html" class="h2 text-decoration-none text-dark">Suscripción Básica</a>
                                <li class="text-muted text-right">Gratis</li>
                            </ul>
                            
                            <p class="card-text">
                                Con esta suscripcion tendras acceso a .....
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 mb-4">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled">
                                <li class="d-flex justify-content-between">
                                    <a href="shop-single.html" class="h2 text-decoration-none text-dark">Suscripción Premium</a>
                                    <span class="text-muted text-right">12.99 mes</span>
                                    <span class="text-muted text-right">129.99 año</span>
                                </li>
                            </ul>
                            <p class="card-text">
